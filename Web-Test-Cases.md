...
**TS-WEB-AUTH-001 — Verify user cannot register using an invalid email domain**
...
### TS-WEB-PROFILE-001 — Verify phone number field accepts numeric characters only
...
### TS-WEB-PROFILE-002 — Verify name field accepts alphabetic characters only
...
### TS-WEB-PROFILE-003 — Verify system displays error message when uploading profile photo larger than 1MB
...
### TS-WEB-PROFILE-004 — Verify profile photo is displayed correctly on homepage
...
### TS-WEB-PRODUCT-001 — Verify seller can publish a product with valid input data
...
### TS-WEB-PRODUCT-002 — Verify system prevents product publishing without photos
...
### TS-WEB-PRODUCT-003 — Verify seller can preview product before publishing
...
### TS-WEB-PRODUCT-004 — Verify system prevents product preview without photos
...
### TS-WEB-PRODUCT-005 — Verify system rejects product publishing with negative price
...
### TS-WEB-NEGOTIATION-001 — Verify negotiation price input has maximum digit limit
...
### TS-WEB-NEGOTIATION-002 — Verify system rejects negative negotiation price
